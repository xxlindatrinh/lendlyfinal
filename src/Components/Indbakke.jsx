  ...
  const messages = [
    {
      ...
      name: "Michael",
      time: "3 timer siden",
      message: "Ville det være muligt at låne den i en dag ekstra?",
    },
    {
      id: 2,
      name: "Lone",
      time: "7 timer siden",
      message: "Hvad er prisen for 2 måneder?",
    },
    {
      id: 3,
      name: "Ida",
      time: "13 timer siden",
      message: "Har du tilbehør til den?",
    },
    {
      id: 4,
      name: "Casper",
      time: "19 timer siden",
      message: "Hej! Jeg kan evt. hente i morgen efter arbejde?",
    },
  ];
            ...
            <div key={msg.id} className="message-item">
              ...
              <div className="message-content">
                ...
                <div className="message-image">
                  <img src="img/trillebør.webp" alt="Trillebør" />
                </div>
              </div>
            </div>
          ))}
